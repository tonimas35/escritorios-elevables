    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <aside className="lg:w-72 shrink-0">
          <div className="lg:sticky lg:top-24 space-y-6 p-5 rounded" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
          ...
          {filtered.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filtered.map(([asin, product], i) => (
                <div key={asin} className={`animate-fade-up stagger-${Math.min(i + 1, 5)}`}>
